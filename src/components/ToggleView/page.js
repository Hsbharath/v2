...
const ToggleView = () => {
  ...
  return (
    <div className='fixed top-[20px] right-[20px] flex items-center justify-between w-[180px] h-[50px] bg-white border-2 border-slate-800 rounded-md overflow-hidden z-50'>
      <button
